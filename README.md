# cloud-itonami-lei-635400eg4yijljmzj782

> **Independent third-party archive/analysis. Not affiliated with, endorsed by, or sponsored by Flutter Entertainment Public Limited Company.**

This repository archives the publicly published Terms of Use / Terms and Conditions of
**Flutter Entertainment Public Limited Company**, with source-url and retrieval-date provenance, per
...
- **Legal name**: Flutter Entertainment Public Limited Company
- **LEI (ISO 17442)**: [635400EG4YIJLJMZJ782](https://search.gleif.org/#/record/635400EG4YIJLJMZJ782) (GLEIF-verified)
- **Jurisdiction**: IE
